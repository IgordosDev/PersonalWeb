...
document.addEventListener("DOMContentLoaded", function () {
    ...
    attributionLink.addEventListener('click', () => {
        Swal.fire({
            ...
            html: '<a href="https://immails.su">I\'mMails</a> за помощь со скриптами и вёрсткой,<br><a href="https://rofl-here.glitch.me/">𝑅 🍬𝐹 𝐿</a> за основную карточку и всё что выше,<br><a href="https://web.archive.org/web/20230320090056/https://dis.gd/clyde">Clyde</a> за виджет last.fm,<br><a href="https://bitor.in/">bit0r1n</a> за выделение домена<br>и <a href="https://fadeinsi.de">fadeinside</a> за ключ к API last.fm.<br>При нажатии на <b>OK</b> - произойдёт переход на репозиторий сайта.',
            icon: 'info',
